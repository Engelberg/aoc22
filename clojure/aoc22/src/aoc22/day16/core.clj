...
(defnc all-completed-states [states completed-states]
  ...
  (< (upper-bound state) (:flow @best-state)) (recur states completed-states)
  (recur (into states (next-states state)) completed-states))

(defnc solution-part-2 "Prints solution quickly, proves optimality in about 4 seconds" []
  (binding [*MAXTIME* 26]
